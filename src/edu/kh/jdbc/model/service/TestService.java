...
// 클래스명을 생략할 수 있게하는 구문
// import static ...    .*;
import  static edu.kh.jdbc.common.JDBCTemplate.*; // 이안의 모든것을 static으로 가져온다
// Connection conn = JDBCTemplate.getConnection(); 이걸
// Connection conn = getConnection(); 이렇게 쓸 수 있음
...
// -> Connection 객체(commit, rollback 제공) 생성
...
public class TestService {
	...
	public int insert(TestVO vo1) throws SQLException {
		...
		Connection conn = getConnection();
					      // static이니까 클래스명.메서드명으로 불러오기(JDBCTemplate)에서 만든것
